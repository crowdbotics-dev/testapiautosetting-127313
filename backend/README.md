...
## Project Structure
    ...
    ├── testapiautosetting_127313  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127313`
...
2. Clone this repo and `cd testapiautosetting_127313`
